...
<head>
  ...
  <meta name="description" content="This is a practical bootstrap project done by Nnorom Precious Akachukwu">
...
<body>
    ...
    <nav class="navbar py-3 navbar-light navbar-expand-sm bg-primary ">
        <!-- logo -->
        <!-- I can add an image too -->
        <a href="#" class="navbar-brand text-uppercase font-italic"> <b>first website</b> </a>
        ...
        <div class="container">
            <div class="row height align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted lead py-2 w-75">Lorem ipsum dolor sit amet, consectetur adipisicing
                        elit. Ipsam, adipisci
                        nisi eos repellat vero ab minus! Atque impedit sunt maxime.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 text-center my-4">
                    ...
                    <p class="text-muted">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                        Omnis similique provident, excepturi odit accusamus repudiandae.</p>
        ...
        <div class="container">
            ...
            <div class="row py-3">
                ...
                <div class="col sm-6 col-md-4 my-3 mx-auto">
                    <img src="img/img2.svg" class="img-fluid rounded" alt="projects">
                ...
                <div class="col sm-6 col-md-4 my-3">
                    <img src="img/img1.svg" class="img-fluid img-thumbnail bg-danger border border-danger"
                        alt="projects">
                ...
                <!-- single project -->
                <div class="col sm-6 col-md-4 my-3">
                    <img src="img/img3.svg" class="img-fluid rounded-circle" alt="projects">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 my-3">
                    <div class="card">
                        <img src="img/img4.svg" alt="member" class="card-img-top">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4 my-3">
                    <div class="card">
                        <img src="img/img5.svg" alt="member" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title text-capitalize">team member</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. At, quis.
                ...
                <div class="col-md-6 col-lg-4 my-3">
                    <div class="card">
                        <img src="img/img6.svg" alt="member" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title text-capitalize">team member</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. At, quis.
                ...
                <div class="col-md-6 col-lg-4 my-3 mx-auto">
                    <div class="card">
                        <img src="img/img7.svg" alt="member" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title text-capitalize">team member</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. At, quis.
                ...
                <div class="col-md-6 col-lg-4 my-3 mx-auto">
                    <div class="card">
                        <img src="img/img8.svg" alt="member" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title text-capitalize">team member</h5>
                            <p class="card-text">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. At, quis.
                    ...
                    <div id="example" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="img/img4.svg" alt="project" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <img src="img/img1.svg" alt="project" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <img src="img/img2.svg" alt="project" class="d-block w-100">
                            </div>
                            <div class="carousel-item">
                                <img src="img/img3.svg" alt="project" class="d-block w-100">
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mx-auto text-center">
                    ...
                    <p class="lead text-warning">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Sequi accusantium autem tempore laborum excepturi
                        perspiciatis officia aliquam suscipit iusto fugiat?</p>
                    <a href="#" class="btn btn-lg btn-primary m-2 text-capitalize">press here</a>
                </div>
            </div>
        </div>
    ...
    <section id="blog" class="p-5 bg-success">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <img src="img/img5.svg" class="img-fluid img-thumbnail" alt="blog">
                    <h2 class="my-3 text-warning">project 1</h2>
                    <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, quod?</p>



                </div>
                <div class="col-md-4 mt-3">
                    <img src="img/img4.svg" class="img-fluid img-thumbnail" alt="blog">
                    <h2 class="my-3 text-warning">project 1</h2>
                    <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, quod?</p>
                ...
                <div class="col-md-4 mt-5">
                    <img src="img/img6.svg" class="img-fluid img-thumbnail" alt="blog">
                    <h2 class="my-3 text-warning">project 1</h2>
                    <p class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo, quod?</p>
                ...
                <div class="card card-body bg-secondary">
                    ...
                    <form>
                        ...
                        <div class="input-group my-3">
                            ...
                            <input type="text" id="group-username" class="form-control">
                        </div>
                        <!-- font-awesome -->
                        <div class="input-group my-3">
                            <!-- prepend -->
                            ...
                            <!-- end of prepend -->
                            <input type="text" id="group-username-1" class="form-control" placeholder="username">
                            <!-- append -->
            ...
            <div class="col-md-6 my-3">
                <div class="embed-responsive embed-responsive-4by3">
                    ...
                    <iframe class="embed-responsive-item"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63543.087420899035!2d6.
                            991166263112763!3d5.50105236615987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x
                            104259980202a4a1%3A0x2b97fd8924660eb1!2sOwerri!5e0!3m2!1sen!2sng!4v1603111085830!5m2!1s
                            en!2sng" width="600" height="450"
    ...
    <!-- review section -->
    <section id="review" class="py-s bg-danger">
        <div class="container">
            <!--section-title -->
            <div class="row">
                <div class="col text-center">
            ...
            <div class="row">
                <div class="col-md-6 my-4">
                    <img src="img/img6.svg" class="img-fluid rounded-circle d-none d-md-block" alt="">
                ...
                <div class="col-md-6 my-4">
                    <blockquote class="blockquote text-right">
                        <p>
                            <i class="fas fa-quote-left fa-2x mr-3"></i> Lorem ipsum dolor sit amet
                            consectetur, adipisicingelit.
                            Sequi repellendus vero sed odio libero nesciunt!</p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <!-- progress bar single -->
                    <h1 class="text-primary">html</h1>
                    <div class="progress bg-secondary">
                        <div class="progress-bar bg-success" style="width: 20%;"></div>
                    </div>
                    <!-- progress bar single -->
                    <h1 class="text-primary">css</h1>
                    <div class="progress bg-secondary">
                        <div class="progress-bar bg-danger" style="width: 40%;"></div>
                    </div>
                    <!-- progress bar single -->
                    <h1 class="text-primary">js</h1>
                    <div class="progress bg-secondary">
                        <div class="progress-bar bg-warning" style="width: 60%;"></div>
                    </div>
                    <!-- progress bar single -->

                    <div class="prog my-3 text-primary d-flex justify-content-between">
                        <h3>bootstrap</h3>
                        <h3>80% </h3>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4 my-4">
                    <div class="card">
                        <!-- card header    -->
                        <div class="card-header bg-primary text-uppercase text-center py-4">
                            <h3>standard</h3>
                        </div>
                        <!-- card title -->
    ...
    <footer id="footer" class="bg-dark py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col text-center">
                    <a href="https://web.facebook.com/akachukwu.precious.988/" target="blank" class="btn">
                        <i class="fab fa-facebook fa-3x text-primary m-2"></i>
                    </a>
                    <a href="http://twitter.com/@AkachukwuNnorom" target="blank" class="btn">
                        <i class="fab fa-twitter fa-3x text-primary m-2"></i>
                    </a>
                    <a href="https://www.instagram.com/p/CHC-yxMp62s/?igshid=j8eun7vdsvqr" target="blank" class="btn">
